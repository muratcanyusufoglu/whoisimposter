...
const DA_LISTS: WordListMap = {
  ancient: require('@/data/words/da/ancient.json') as WordList,
  animals: require('@/data/words/da/animals.json') as WordList,
  brands: require('@/data/words/da/brands.json') as WordList,
  countries: require('@/data/words/da/countries.json') as WordList,
  disney: require('@/data/words/da/disney.json') as WordList,
  drinks: require('@/data/words/da/drinks.json') as WordList,
  education: require('@/data/words/da/education.json') as WordList,
  famous: require('@/data/words/da/famous.json') as WordList,
  fashion: require('@/data/words/da/fashion.json') as WordList,
  flowers: require('@/data/words/da/flowers.json') as WordList,
  food: require('@/data/words/da/food.json') as WordList,
  hobbies: require('@/data/words/da/hobbies.json') as WordList,
  'internet-culture': require('@/data/words/da/internet-culture.json') as WordList,
  jobs: require('@/data/words/da/jobs.json') as WordList,
  'movies-tv': require('@/data/words/da/movies-tv.json') as WordList,
  music: require('@/data/words/da/music.json') as WordList,
  mythology: require('@/data/words/da/mythology.json') as WordList,
  nature: require('@/data/words/da/nature.json') as WordList,
  objects: require('@/data/words/da/objects.json') as WordList,
  olympics: require('@/data/words/da/olympics.json') as WordList,
  'party-life': require('@/data/words/da/party-life.json') as WordList,
  places: require('@/data/words/da/places.json') as WordList,
  science: require('@/data/words/da/science.json') as WordList,
  scientists: require('@/data/words/da/scientists.json') as WordList,
  social: require('@/data/words/da/social.json') as WordList,
  spicy: require('@/data/words/da/spicy.json') as WordList,
  sports: require('@/data/words/da/sports.json') as WordList,
  superheroes: require('@/data/words/da/superheroes.json') as WordList,
  technology: require('@/data/words/da/technology.json') as WordList,
  'tv-series': require('@/data/words/da/tv-series.json') as WordList,
  vehicles: require('@/data/words/da/vehicles.json') as WordList,
  'video-games': require('@/data/words/da/video-games.json') as WordList,
}

const NB_LISTS: WordListMap = {
  ancient: require('@/data/words/nb/ancient.json') as WordList,
  animals: require('@/data/words/nb/animals.json') as WordList,
  brands: require('@/data/words/nb/brands.json') as WordList,
  countries: require('@/data/words/nb/countries.json') as WordList,
  disney: require('@/data/words/nb/disney.json') as WordList,
  drinks: require('@/data/words/nb/drinks.json') as WordList,
  education: require('@/data/words/nb/education.json') as WordList,
  famous: require('@/data/words/nb/famous.json') as WordList,
  fashion: require('@/data/words/nb/fashion.json') as WordList,
  flowers: require('@/data/words/nb/flowers.json') as WordList,
  food: require('@/data/words/nb/food.json') as WordList,
  hobbies: require('@/data/words/nb/hobbies.json') as WordList,
  'internet-culture': require('@/data/words/nb/internet-culture.json') as WordList,
  jobs: require('@/data/words/nb/jobs.json') as WordList,
  'movies-tv': require('@/data/words/nb/movies-tv.json') as WordList,
  music: require('@/data/words/nb/music.json') as WordList,
  mythology: require('@/data/words/nb/mythology.json') as WordList,
  nature: require('@/data/words/nb/nature.json') as WordList,
  objects: require('@/data/words/nb/objects.json') as WordList,
  olympics: require('@/data/words/nb/olympics.json') as WordList,
  'party-life': require('@/data/words/nb/party-life.json') as WordList,
  places: require('@/data/words/nb/places.json') as WordList,
  science: require('@/data/words/nb/science.json') as WordList,
  scientists: require('@/data/words/nb/scientists.json') as WordList,
  social: require('@/data/words/nb/social.json') as WordList,
  spicy: require('@/data/words/nb/spicy.json') as WordList,
  sports: require('@/data/words/nb/sports.json') as WordList,
  superheroes: require('@/data/words/nb/superheroes.json') as WordList,
  technology: require('@/data/words/nb/technology.json') as WordList,
  'tv-series': require('@/data/words/nb/tv-series.json') as WordList,
  vehicles: require('@/data/words/nb/vehicles.json') as WordList,
  'video-games': require('@/data/words/nb/video-games.json') as WordList,
}

const FI_LISTS: WordListMap = {
  ancient: require('@/data/words/fi/ancient.json') as WordList,
  animals: require('@/data/words/fi/animals.json') as WordList,
  brands: require('@/data/words/fi/brands.json') as WordList,
  countries: require('@/data/words/fi/countries.json') as WordList,
  disney: require('@/data/words/fi/disney.json') as WordList,
  drinks: require('@/data/words/fi/drinks.json') as WordList,
  education: require('@/data/words/fi/education.json') as WordList,
  famous: require('@/data/words/fi/famous.json') as WordList,
  fashion: require('@/data/words/fi/fashion.json') as WordList,
  flowers: require('@/data/words/fi/flowers.json') as WordList,
  food: require('@/data/words/fi/food.json') as WordList,
  hobbies: require('@/data/words/fi/hobbies.json') as WordList,
  'internet-culture': require('@/data/words/fi/internet-culture.json') as WordList,
  jobs: require('@/data/words/fi/jobs.json') as WordList,
  'movies-tv': require('@/data/words/fi/movies-tv.json') as WordList,
  music: require('@/data/words/fi/music.json') as WordList,
  mythology: require('@/data/words/fi/mythology.json') as WordList,
  nature: require('@/data/words/fi/nature.json') as WordList,
  objects: require('@/data/words/fi/objects.json') as WordList,
  olympics: require('@/data/words/fi/olympics.json') as WordList,
  'party-life': require('@/data/words/fi/party-life.json') as WordList,
  places: require('@/data/words/fi/places.json') as WordList,
  science: require('@/data/words/fi/science.json') as WordList,
  scientists: require('@/data/words/fi/scientists.json') as WordList,
  social: require('@/data/words/fi/social.json') as WordList,
  spicy: require('@/data/words/fi/spicy.json') as WordList,
  sports: require('@/data/words/fi/sports.json') as WordList,
  superheroes: require('@/data/words/fi/superheroes.json') as WordList,
  technology: require('@/data/words/fi/technology.json') as WordList,
  'tv-series': require('@/data/words/fi/tv-series.json') as WordList,
  vehicles: require('@/data/words/fi/vehicles.json') as WordList,
  'video-games': require('@/data/words/fi/video-games.json') as WordList,
}

const HI_LISTS: WordListMap = {
  ancient: require('@/data/words/hi/ancient.json') as WordList,
  animals: require('@/data/words/hi/animals.json') as WordList,
  brands: require('@/data/words/hi/brands.json') as WordList,
  countries: require('@/data/words/hi/countries.json') as WordList,
  disney: require('@/data/words/hi/disney.json') as WordList,
  drinks: require('@/data/words/hi/drinks.json') as WordList,
  education: require('@/data/words/hi/education.json') as WordList,
  famous: require('@/data/words/hi/famous.json') as WordList,
  fashion: require('@/data/words/hi/fashion.json') as WordList,
  flowers: require('@/data/words/hi/flowers.json') as WordList,
  food: require('@/data/words/hi/food.json') as WordList,
  hobbies: require('@/data/words/hi/hobbies.json') as WordList,
  'internet-culture': require('@/data/words/hi/internet-culture.json') as WordList,
  jobs: require('@/data/words/hi/jobs.json') as WordList,
  'movies-tv': require('@/data/words/hi/movies-tv.json') as WordList,
  music: require('@/data/words/hi/music.json') as WordList,
  mythology: require('@/data/words/hi/mythology.json') as WordList,
  nature: require('@/data/words/hi/nature.json') as WordList,
  objects: require('@/data/words/hi/objects.json') as WordList,
  olympics: require('@/data/words/hi/olympics.json') as WordList,
  'party-life': require('@/data/words/hi/party-life.json') as WordList,
  places: require('@/data/words/hi/places.json') as WordList,
  science: require('@/data/words/hi/science.json') as WordList,
  scientists: require('@/data/words/hi/scientists.json') as WordList,
  social: require('@/data/words/hi/social.json') as WordList,
  spicy: require('@/data/words/hi/spicy.json') as WordList,
  sports: require('@/data/words/hi/sports.json') as WordList,
  superheroes: require('@/data/words/hi/superheroes.json') as WordList,
  technology: require('@/data/words/hi/technology.json') as WordList,
  'tv-series': require('@/data/words/hi/tv-series.json') as WordList,
  vehicles: require('@/data/words/hi/vehicles.json') as WordList,
  'video-games': require('@/data/words/hi/video-games.json') as WordList,
}

const ID_LISTS: WordListMap = {
  ancient: require('@/data/words/id/ancient.json') as WordList,
  animals: require('@/data/words/id/animals.json') as WordList,
  brands: require('@/data/words/id/brands.json') as WordList,
  countries: require('@/data/words/id/countries.json') as WordList,
  disney: require('@/data/words/id/disney.json') as WordList,
  drinks: require('@/data/words/id/drinks.json') as WordList,
  education: require('@/data/words/id/education.json') as WordList,
  famous: require('@/data/words/id/famous.json') as WordList,
  fashion: require('@/data/words/id/fashion.json') as WordList,
  flowers: require('@/data/words/id/flowers.json') as WordList,
  food: require('@/data/words/id/food.json') as WordList,
  hobbies: require('@/data/words/id/hobbies.json') as WordList,
  'internet-culture': require('@/data/words/id/internet-culture.json') as WordList,
  jobs: require('@/data/words/id/jobs.json') as WordList,
  'movies-tv': require('@/data/words/id/movies-tv.json') as WordList,
  music: require('@/data/words/id/music.json') as WordList,
  mythology: require('@/data/words/id/mythology.json') as WordList,
  nature: require('@/data/words/id/nature.json') as WordList,
  objects: require('@/data/words/id/objects.json') as WordList,
  olympics: require('@/data/words/id/olympics.json') as WordList,
  'party-life': require('@/data/words/id/party-life.json') as WordList,
  places: require('@/data/words/id/places.json') as WordList,
  science: require('@/data/words/id/science.json') as WordList,
  scientists: require('@/data/words/id/scientists.json') as WordList,
  social: require('@/data/words/id/social.json') as WordList,
  spicy: require('@/data/words/id/spicy.json') as WordList,
  sports: require('@/data/words/id/sports.json') as WordList,
  superheroes: require('@/data/words/id/superheroes.json') as WordList,
  technology: require('@/data/words/id/technology.json') as WordList,
  'tv-series': require('@/data/words/id/tv-series.json') as WordList,
  vehicles: require('@/data/words/id/vehicles.json') as WordList,
  'video-games': require('@/data/words/id/video-games.json') as WordList,
}
